...
version_file_path = __here__ / "il2fb" / "ds" / "events" / "definitions" / "version.py"
...
setup(
  name="il2fb-ds-events",
  version=VERSION,
  description=(
    "Definitions of events of the dedicated server of "
  ...
  keywords=[
    ...
    "ds", "event", "events", "structure", "structures",
  ],
  license="MIT",
  url=f"https://github.com/IL2HorusTeam/il2fb-ds-events/tree/v{VERSION}",

  author="Oleksandr Oblovatnyi",
  author_email="oblovatniy@gmail.com",

  packages=[
    "il2fb.ds.events.definitions",
  ],
  namespace_packages=[
    "il2fb",
    "il2fb.ds",
